...
const sections = [
  ...
  {
    title: 'Inventory',
    description: 'Log stock entries and track usage over time',
  ...
  {
    title: 'Invoices',
    description: 'Purchasing invoices and supplier records',
      ...
      <div className="max-w-3xl mx-auto">
        <div className="mb-10 text-center">
          ...
          <p className="text-slate-500 dark:text-slate-400">
            Manage your ingredients, stock levels and supplier invoices
          </p>
        </div>
