...
const sections = [
  {
    title: 'Restaurant',
    description: 'Name, phone, logo and general info',
  ...
  {
    title: 'Tax & Invoicing',
    description: 'Tax system, rates, and invoice configuration',
  ...
  {
    title: 'Product Tax',
    description: 'Assign tax rates to individual products',
  ...
  {
    title: 'Discounts',
    description: 'Promotions, discount codes and offers',
  ...
  {
    title: 'Security',
    description: 'Staff login password and access control',
  ...
  {
    title: 'Other Options',
    description: 'Miscellaneous preferences and toggles',
      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-10 text-center">
          ...
          <p className="text-slate-500 dark:text-slate-400">
            {restaurant?.name ? `Manage ${restaurant.name}` : 'Manage your restaurant settings'}
          </p>
        </div>
