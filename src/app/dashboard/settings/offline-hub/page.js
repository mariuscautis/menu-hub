          ...
          <div className="bg-white dark:bg-slate-900 border-2 border-slate-100 dark:border-slate-800 rounded-2xl p-6">
            ...
            <div className="border-t border-slate-100 dark:border-slate-800 pt-5">
              ...
              {restaurant?.bridge_hub_ip && (
                <div className="p-4 bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-100 dark:border-indigo-800 rounded-xl flex items-center justify-between gap-4 mb-5">
                  <div>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex-shrink-0 px-4 py-2 bg-[#6262bd] text-white rounded-lg text-xs font-semibold hover:bg-[#5252a3] transition-colors whitespace-nowrap"
                  >
                    Trust certificate →
                  </a>
                </div>
