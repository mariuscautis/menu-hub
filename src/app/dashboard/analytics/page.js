...
const sections = [
  {
    title: 'Overview',
    description: 'Revenue, orders, profit trends and top products',
  ...
  {
    title: 'Tables',
    description: 'Revenue and performance broken down by table',
  ...
  {
    title: 'Staff',
    description: 'Sales and performance per staff member',
  ...
  {
    title: 'Losses',
    description: 'Waste, voids, and loss tracking over time',
  ...
  {
    title: 'Labor',
    description: 'Hours worked, cost, and labor efficiency',
      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-10 text-center">
          ...
          <p className="text-slate-500 dark:text-slate-400">
            {t('hubSubtitle') || 'Insights and performance across your restaurant'}
          </p>
        </div>
