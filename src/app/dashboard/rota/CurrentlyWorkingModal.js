    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl p-8 max-w-5xl w-full max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h2 className="text-2xl font-bold text-slate-800">Today's Attendance</h2>
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-slate-600 text-lg font-medium">No attendance records for today</p>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b-2 border-slate-200">
                  <th className="text-left py-3 px-4 text-sm font-semibold text-slate-700">Staff</th>
                  <th className="text-left py-3 px-4 text-sm font-semibold text-slate-700">Role</th>
                  <th className="text-left py-3 px-4 text-sm font-semibold text-slate-700">Department</th>
                  <th className="text-left py-3 px-4 text-sm font-semibold text-slate-700">Status</th>
                  <th className="text-left py-3 px-4 text-sm font-semibold text-slate-700">Clocked In</th>
                  <th className="text-left py-3 px-4 text-sm font-semibold text-slate-700">Clocked Out</th>
                  <th className="text-left py-3 px-4 text-sm font-semibold text-slate-700">Scheduled Out</th>
                    ...
                    <td className="py-4 px-4">
                      <div className="text-sm">
                        {attendance.clock_out ? (
                          ...
                          <span className="text-slate-400 italic">Still working</span>
                        )}
                      </div>
                    </td>
                    <td className="py-4 px-4">
