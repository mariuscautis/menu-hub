          ...
          {reportData.products.length === 0 ? (
            ...
            <>
              ...
              <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-sm overflow-hidden">
                ...
                {/* Table header */}
                <div className="hidden md:grid grid-cols-9 gap-2 px-5 py-3 bg-zinc-50 dark:bg-zinc-50 dark:bg-zinc-900/50 text-xs font-semibold text-zinc-500 dark:text-zinc-400 dark:text-zinc-400 uppercase tracking-wide">
                    ...
                    return (
                      <div key={product.id}>
                        ...
                        {isExpanded && hasRecipe && (
                          <div className="bg-zinc-50 dark:bg-zinc-900/40 border-t border-zinc-200 dark:border-zinc-800 px-10 py-3">
                            ...
                            <div className="mt-2 pt-2 border-t border-zinc-200 dark:border-zinc-700 grid grid-cols-5 gap-2 text-xs font-semibold">
                ...
                {/* Table footer */}
                <div className="px-5 py-4 bg-zinc-50 dark:bg-zinc-50 dark:bg-zinc-900/50 border-t-2 border-zinc-200 dark:border-zinc-700 hidden md:grid grid-cols-9 gap-2 text-sm font-bold text-zinc-800 dark:text-zinc-200 dark:text-zinc-200">
