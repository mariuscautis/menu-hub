...
export async function POST(request) {
  ...
  try {
    ...
    // Create in-app notification if shift is published and staff is assigned
    // (email notifications are batched via the "Send Rota Notifications" button)
...
export async function PUT(request) {
  ...
  try {
    ...
    // Create in-app notifications based on shift changes
    // (email notifications are batched via the "Send Rota Notifications" button)
