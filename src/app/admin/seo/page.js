...
const DEFAULTS = {
  ...
  services_offline_hub:      { title: 'Keep Serving Even Without Internet — Veno App Offline Hub', description: 'Veno App keeps working even when your internet goes down. Orders and kitchen displays stay live on your local network — then sync automatically the moment you reconnect.' },
