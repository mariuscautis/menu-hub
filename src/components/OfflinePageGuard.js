...
/**
 * Wraps a data-heavy page that cannot function offline.
 * When the device is offline, renders a clear in-app message instead of
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-6 text-center">
      ...
      <p className="text-slate-500 dark:text-slate-400 max-w-sm mb-8">
        You're currently offline. This page will load automatically once your connection is restored.
      </p>

      <div className="flex flex-col sm:flex-row gap-3">
        <Link
          href="/dashboard/tables"
          className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#6262bd] hover:bg-[#5151a8] text-white rounded-xl font-medium text-sm transition-colors"
        >
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 px-5 py-2.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-700 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-200 rounded-xl font-medium text-sm transition-colors"
        >
          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
