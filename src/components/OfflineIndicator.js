    ...
    <>
      ...
      {showNotification && (
        <div className="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 animate-slide-down">
          {isOnline ? (
            <div className="bg-green-500 text-white px-6 py-3 rounded-sm shadow-lg flex items-center gap-3">
            ...
            <div className="bg-yellow-500 text-white px-4 py-2 rounded-sm shadow-lg flex items-center gap-2 text-sm">
              ...
              <span className="font-medium">Offline — orders saved locally</span>
            </div>
          )}
        </div>
      )}
      ...
      {lastSyncResult && (
        <div className="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 animate-slide-down">
          <div className={`${lastSyncResult.failed > 0 ? 'bg-amber-500' : 'bg-green-500'} text-white px-6 py-3 rounded-sm shadow-lg flex items-center gap-3`}>
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
            </svg>
          ...
          <div className="max-w-4xl mx-auto flex items-center justify-between">
            ...
            {isOnline && !isSyncing && (
              <button
                ...
                className="bg-white dark:bg-zinc-900/20 hover:bg-white dark:bg-zinc-900/30 px-4 py-1.5 rounded-sm font-medium text-sm transition-colors"
              >
                Sync now
              </button>
            )}
