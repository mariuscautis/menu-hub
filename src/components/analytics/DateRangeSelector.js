...
export default function DateRangeSelector({ onRangeChange }) {
  ...
  return (
    <div className="bg-white border-2 border-slate-100 rounded-none p-6">
        ...
        <div className="space-y-3 pt-3 border-t border-slate-200">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border-2 border-slate-200 rounded-none focus:outline-none focus:border-[#6262bd]"
            />
          </div>
          <div>
          ...
          <button
            ...
            className="w-full px-4 py-2 bg-[#6262bd] text-white rounded-none font-medium hover:bg-[#5252a3] disabled:bg-slate-300 disabled:cursor-not-allowed transition-colors"
          >
            {t('applyCustomRange')}
          </button>
        </div>
